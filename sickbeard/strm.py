...
def _getSeasonNZBs(name, urlData, season, showName):
    ...
    #logger.log(u"name:" + name + "urlData:" + urlData + "season:" + season + "showName:" + showname logger.ERROR)
...
def saveSTRM(nzb):
    ...
    nzb.name = nzb.name.replace(':', '')
    logger.log("nzb: " + nzb.name)
    ...
    if len(episodeList) > 1:
        for episode in episodeList:
            ...
            fileContents = "plugin://plugin.program.pneumatic/?mode=strm&type=addurl&nzb=" + sickbeard.PNEU_NZB_DIR + episode.name + ".nzb" + "&nzbname=" + episode.name
        ...
        fileContents = "plugin://plugin.program.pneumatic/?mode=strm&type=addurl&nzb=" + sickbeard.PNEU_NZB_DIR + nzb.name + ".nzb" + "&nzbname=" + nzb.name
